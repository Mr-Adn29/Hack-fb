...
os.system('clear')
print'\x1b[1;92mTunggu'
time.sleep(3)
print'\x1b[1;92mSedang Dalam Proses'
time.sleep(5)
os.system('clear')
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://m.facebook.com/profile.php?id=100039000913754')
                time.sleep(2)
                menu()
